  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#18181B] flex flex-col items-center justify-center text-zinc-100">
        ...
        <p className="text-zinc-400">The Master Smith is crafting a personalized path for {displayCareer}.</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen p-8 text-zinc-100">
      <div className="max-w-4xl mx-auto">
        <header className="mb-16 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-black font-['Outfit'] tracking-tight mb-6 text-zinc-100 drop-shadow-sm">
            ...
            <div key={index} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              ...
              <div className="w-[calc(100%-5rem)] md:w-[calc(50%-3rem)] forge-card p-8 group-hover:border-amber-700/50">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-bold text-2xl font-['Outfit'] text-zinc-100">{milestone.title}</h3>
                ...
                <div className="space-y-6">
                  ...
                  {milestone.projects && milestone.projects.length > 0 && (
                    <div className="p-5 bg-[#27272A]/80 rounded-xl border border-[#3F3F46] shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
                      ...
                      <div className="flex items-center gap-2 text-zinc-200 font-bold font-['Outfit'] text-lg">
